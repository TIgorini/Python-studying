...
1. Для тексту кожного повідомлення, які було отримано в лабораторній роботі No2,
...
TF/IDF-векторизацію
повідомлень.
3. За допомогою scikit-learn застосувати до підготовлених даних алгоритм
кластеризації KMeans.
